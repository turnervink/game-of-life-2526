...
public final class Main {
     ...
     * @throws CouldNotAddException if the neighbours for a Cell in the World
     *                              could not be retrieved
     */
    public static void main(final String[] argv) throws CouldNotAddException {
     ...
     * @return Point the center point of the screen
     */
     ...
     * @return Dimension the area of the screen
     */
